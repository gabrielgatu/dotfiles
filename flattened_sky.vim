" 'flattened_sky.vim' -- Vim color scheme.
" Maintainer:   Gabriel Gatu (gabrielgatu@icloud.com)
" Description:  Simple and clean vim theme.
...
let colors_name = 'flattened_sky'

hi Normal                                  cterm=NONE  ctermfg=11  ctermbg=15  guifg=#657b83  guibg=#ffffff  gui=NONE

set background=light

hi ColorColumn                             cterm=NONE  ctermbg=7  guibg=#ffffff  gui=NONE
hi Comment                                 cterm=NONE  ctermfg=14  gui=italic  guifg=#93a1a1  gui=NONE
hi ConId                                   cterm=NONE  ctermfg=3  guifg=#657b83  gui=NONE
hi Conceal                                 cterm=NONE  ctermfg=4  guifg=#268bd2  gui=NONE
hi Constant                                cterm=NONE  ctermfg=6  guifg=#2aa198  gui=NONE
hi Cursor                                  cterm=NONE  ctermfg=15  ctermbg=11  guifg=#ffffff  guibg=#657b83  gui=NONE
hi CursorColumn                            cterm=NONE  ctermbg=7  guibg=#ffffff  gui=NONE
hi CursorLine                              cterm=NONE  ctermbg=7  guibg=#ffffff  guisp=#586e75  gui=NONE
hi CursorLineNr                            ctermfg=130  gui=NONE  guifg=brown
hi DiffAdd                                 cterm=NONE  ctermfg=2  ctermbg=7  gui=NONE  guifg=#719e07  guibg=#ffffff  guisp=#719e07  gui=NONE
hi DiffChange                              cterm=NONE  ctermfg=3  ctermbg=7  gui=NONE  guifg=#657b83  guibg=#ffffff  guisp=#657b83  gui=NONE
hi DiffDelete                              cterm=NONE  ctermfg=1  ctermbg=7  gui=NONE  guifg=#dc322f  guibg=#ffffff  gui=NONE
hi DiffText                                cterm=NONE  ctermfg=4  ctermbg=7  gui=NONE  guifg=#268bd2  guibg=#ffffff  guisp=#268bd2  gui=NONE
...
hi FoldColumn                              cterm=NONE  ctermfg=11  ctermbg=7  guifg=#657b83  guibg=#ffffff  gui=NONE
hi Folded                                  cterm=NONE,underline  ctermfg=11  ctermbg=7  gui=NONE,underline  guifg=#657b83  guibg=#ffffff  guisp=#ffffff  gui=NONE
...
hi LineNr                                  cterm=NONE  ctermfg=14  ctermbg=7  guifg=#93a1a1  guibg=#ffffff  gui=NONE
...
hi Pmenu                                   cterm=reverse  ctermfg=11  ctermbg=7  cterm=NONE  gui=reverse  guifg=#657b83  guibg=#ffffff  guibg=NONE
...
hi PmenuThumb                              cterm=reverse  ctermfg=11  ctermbg=15  cterm=NONE  gui=reverse  guifg=#657b83  guibg=#ffffff  guibg=NONE
hi PreProc                                 cterm=NONE  ctermfg=9  guifg=#cb4b16  gui=NONE
hi Question                                cterm=NONE  ctermfg=6  gui=NONE  guifg=#2aa198  gui=NONE
hi Search                                  cterm=reverse  ctermfg=3  cterm=NONE  gui=reverse  guifg=#657b83  guibg=NONE
...
hi SpecialKey                              cterm=NONE  ctermfg=12  ctermbg=7  gui=NONE  guifg=#839496  guibg=#ffffff  gui=NONE
hi SpellBad                                cterm=undercurl  gui=undercurl  guisp=#dc322f
hi SpellCap                                cterm=undercurl  gui=undercurl  guisp=#6c71c4
hi SpellLocal                              cterm=undercurl  gui=undercurl  guisp=#657b83
hi SpellRare                               cterm=undercurl  gui=undercurl  guisp=#2aa198
hi Statement                               cterm=NONE  ctermfg=2  guifg=#719e07  gui=NONE
hi StatusLine                              cterm=reverse  ctermfg=10  ctermbg=7  gui=reverse  guifg=#586e75  guibg=#ffffff  guibg=NONE
hi StatusLineNC                            cterm=reverse  ctermfg=12  ctermbg=7  gui=reverse  guifg=#839496  guibg=#ffffff  guibg=NONE
hi TabLine                                 cterm=underline  ctermfg=11  ctermbg=7  gui=underline  guifg=#657b83  guibg=#ffffff  guisp=#657b83
hi TabLineFill                             cterm=underline  ctermfg=11  ctermbg=7  gui=underline  guifg=#657b83  guibg=#ffffff  guisp=#657b83
...
hi Type                                    cterm=NONE  ctermfg=3  guifg=#657b83  gui=NONE
...
hi Visual                                  cterm=reverse  ctermfg=14  ctermbg=15  cterm=NONE  gui=reverse  guifg=#93a1a1  guibg=#ffffff  guibg=NONE
hi VisualNOS                               cterm=reverse  ctermbg=7  cterm=NONE  gui=reverse  guibg=#ffffff  guibg=NONE
hi WarningMsg                              cterm=NONE  ctermfg=1  gui=NONE  guifg=#dc322f  gui=NONE
hi WildMenu                                cterm=reverse  ctermfg=0  ctermbg=7  cterm=NONE  gui=reverse  guifg=#073642  guibg=#ffffff  guibg=NONE
...
hi gitcommitUnmergedFile                   cterm=NONE  ctermfg=3  gui=NONE  guifg=#657b83  gui=NONE
...
hi hsType                                  cterm=NONE  ctermfg=3  guifg=#657b83  gui=NONE
...
hi hs_OpFunctionName                       cterm=NONE  ctermfg=3  guifg=#657b83  gui=NONE
...
hi javaScript                              cterm=NONE  ctermfg=3  guifg=#657b83  gui=NONE
...
hi pandocBlockQuoteLeader3                 cterm=NONE  ctermfg=3  guifg=#657b83  gui=NONE
...
hi pandocHeadingMarker                     cterm=NONE  ctermfg=3  gui=NONE  guifg=#657b83  gui=NONE
...
hi pandocTableZebraDark                    cterm=NONE  ctermfg=4  ctermbg=7  guifg=#268bd2  guibg=#ffffff  gui=NONE
hi pandocTableZebraLight                   cterm=NONE  ctermfg=4  ctermbg=15  guifg=#268bd2  guibg=#ffffff  gui=NONE
...
hi pandocVerbatimBlock                     cterm=NONE  ctermfg=3  guifg=#657b83  gui=NONE
hi pandocVerbatimInline                    cterm=NONE  ctermfg=3  guifg=#657b83  gui=NONE
...
hi perlHereDoc                             cterm=NONE  ctermfg=10  ctermbg=15  guifg=#586e75  guibg=#ffffff  gui=NONE
hi perlStatementFileDesc                   cterm=NONE  ctermfg=6  ctermbg=15  guifg=#2aa198  guibg=#ffffff  gui=NONE
hi perlVarPlain                            cterm=NONE  ctermfg=3  ctermbg=15  guifg=#657b83  guibg=#ffffff  gui=NONE
hi rubyDefine                              cterm=NONE  ctermfg=10  ctermbg=15  gui=NONE  guifg=#586e75  guibg=#ffffff  gui=NONE
hi texMathMatcher                          cterm=NONE  ctermfg=3  ctermbg=15  guifg=#657b83  guibg=#ffffff  gui=NONE
hi texMathZoneX                            cterm=NONE  ctermfg=3  ctermbg=15  guifg=#657b83  guibg=#ffffff  gui=NONE
hi texRefLabel                             cterm=NONE  ctermfg=3  ctermbg=15  guifg=#657b83  guibg=#ffffff  gui=NONE
hi texStatement                            cterm=NONE  ctermfg=6  ctermbg=15  guifg=#2aa198  guibg=#ffffff  gui=NONE
hi vimCmdSep                               cterm=NONE  ctermfg=4  gui=NONE  guifg=#268bd2  gui=NONE
hi vimCommand                              cterm=NONE  ctermfg=3  guifg=#657b83  gui=NONE
...
hi vimSynMtchOpt                           cterm=NONE  ctermfg=3  guifg=#657b83  gui=NONE
